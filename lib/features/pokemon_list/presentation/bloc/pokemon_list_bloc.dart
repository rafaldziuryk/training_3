...
class PokemonListBloc extends Bloc<PokemonListEvent, PokemonListState> {
  ...
  final TogglePokemonLikeUseCase togglePokemonLikeUseCase;

  PokemonListBloc({
    required this.togglePokemonLikeUseCase,
    ...
    on<PokemonListToggleSelectEvent>((event, emit) async {
      ...
      emit(PokemonListData(
          list: (state as PokemonListData).list, selectedIndex: selectedIndex));
    });
    ...
    on<PokemonListToggleLikedEvent>((event, emit) async {
      emit(PokemonListPending());
      await togglePokemonLikeUseCase(
        TogglePokemonUseCaseParams(pokemon: event.pokemon),
      );
